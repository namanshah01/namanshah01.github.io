...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Naman Shah.</h2>;
  const three = <h3 className="big-heading">I play with 0's and 1's.</h3>;
  const four = (
    <>
      <p>
				I'm a <a>Software Developer</a> and a Computer Science grad student at{' '}
